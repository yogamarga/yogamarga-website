module.exports = function (grunt) {
  ...
  grunt.registerTask('release', ['clean', 'shell:jekyllBuild', 'html2js','uglify','jshint','karma:unit','concat:index', 'less:production', 'copy:all']);
  ...
  grunt.initConfig({
    ...
    src: {
      js: ['<%= project.src %>/app/**/*.js', '../angularjs-common/src/common/**/*.js'],
      ...
      tpl: {
        ...
        common: ['../angularjs-common/src/common/**/*.tpl.html']
      },
      ...
      watch: ['<%= project.watch %>/app/**/*.js', '<%= project.watch %>/app/**/*.html', '../angularjs-common/src/common/**/*.js']
    },
    ...
    */
    ...
    html2js: {
      ...
      common: {
        options: {
          base: '../angularjs-common/src/common'
        },
        src: ['<%= src.tpl.common %>'],
        dest: '<%= project.dist %>/templates/common.js',
    ...
    concat:{
      ...
      angular: {
        src:['vendor/angular/angular.js', 'vendor/angular-route/angular-route.js',
            ...
            'vendor/angular-resource/angular-resource.js', 'vendor/angular-translate/angular-translate.js',
